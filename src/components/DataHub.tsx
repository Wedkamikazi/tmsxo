...
export const DataHub: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'bankStatement' | 'accounts' | 'transactions' | 'bankBalance' | 'fileManager' | 'qwenStatus' | 'dataCleanup' | 'ollamaChat' | 'settings' | 'payroll' | 'investments' | 'reports' | 'creditTransactions' | 'debitTransactions' | 'hrPayments'>(() => getActiveTab() as any);
